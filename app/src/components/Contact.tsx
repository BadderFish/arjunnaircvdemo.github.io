      ...
      <div className="container">
        ...
        <div className={`card contact-card animate-in ${isVisible ? 'visible' : ''}`} style={{ animationDelay: '0.1s' }}>
          ...
          <div className="contact-actions">
            <a className="btn" href={`mailto:${personal.email}`}>Email me</a>
            <a className="btn ghost" href={`tel:${personal.phone}`}>Call</a>
            <a className="btn ghost" href={`https://wa.me/${personal.whatsapp.replace(/\+/g, '')}`} target="_blank" rel="noreferrer">
              <WhatsAppIcon />
              WhatsApp
            </a>
        ...
        <p className="footnote">
          © {currentYear} {personal.name} • Built as a lightweight static site.
        </p>
      </div>
    </section>
  );
